...
class AllResponse:
    ...
    allResponse["whatyoudo"] = ["I am chatting with you,seriously.","Texting texting texting texting texting texting texting","Chit chat! I am Chit-chatting.","I am talking with you.","I have no idea what I am doing right now."]
    ...
    allResponse["really"] = ["Indeed,.","Oh sure.","Yes!", "It is!", "Defenately"]
    ...
    allResponse["errorWord"] =["Please give me a valid input.","No, I am not smart enough to do that.","Please try again.","I do not get that.","You mad? ","You have to ask me again.", "I cannot give you the answer, sorry.."]
    allResponse["preAnswer"] = ["Ok Ok Ok.","This looks hardish, but I am smart enought to do this.","Piece of cake!.","Oh too easy.","You will thank me for this later.","Here you go.","There you go.","Here are you answers."]
    allResponse["image"] = ["Wow, supernice image", "Whose picture is this?", "What a nice image..", "Good image you have here", "Nice Photo !!"]
